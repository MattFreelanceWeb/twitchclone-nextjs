...
function Header({}: Props) {
  return (
    <div className='bg-[#6441a4] h-16 fixed w-full z-50'>
            ...
            <ul className='flex w-full items-center '>
                ...
                <li className=' px-5 mx-auto flex-shrink flex items-center justify-center h-16 w-full ' >
                    <form action=" " className=' h-10 w-full flex flex-shrink items-center justify-center  '>
                        <input type="text"  className='h-10 w-1/2 bg-white border-2 border-white rounded-l-[5px]'/>
                        <button className='rounded-r-[5px] py-1 px-5  bg-gray-200'>
                           <span className='w-5 text-2xl font-bold'><IonIcon name='search' /></span> 
                        </button>
                    </form>
                </li>
            </ul>
        ...
        <div className=' fixed top-0 right-2 cursor-pointer h-16 w-16 flex items-center justify-center'>
             <span className='text-4xl'><IonIcon name='menu' /></span>
        </div>
    </div>
  )
}
